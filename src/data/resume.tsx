...
import { HomeIcon, NotebookIcon, LayersIcon, PaintbrushIcon } from "lucide-react";
...
export const DATA = {
  ...
  summary:
    "A 21 year old full-stack and devops engineer with a love for startups, technology, and creativity. Currently in my final year of CS degree from JEC, Assam, I like to apply first principles approach to problem solving. My interests span across anything artistic (movies / music / literature) to random facts, keeping my curiosity as vast and dynamic as the tech world itself.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Next.js",
  ...
  navbar: [
    ...
    // { href: "/stuff", icon: LayersIcon, label: "Stuff" },
    { href: "/visuals", icon: PaintbrushIcon, label: "Visuals" },
    // { href: "/blog", icon: NotebookIcon, label: "Blog" },
  ],
  contact: {
    email: "hmistakenpirate38@gmail.com",
    // tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/MistakenPirate",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/sameer-kashyap",
        icon: Icons.linkedin,
